    ...
    div [ class "fixed flex justify-center items-center h-screen w-screen" ]
        ...
        , div [ class "bg-gray-600 z-40 w-1/3" ]
            ...
            , div [ class "flex flex-col p-2" ]
                [ if settings.gameStatus /= Game.Core.NoGame then button [ class "bg-blue-300 hover:bg-blue-400 rounded w-full my-1", onClick ExitGame ] [ text "Return to Lobby" ] else text ""
